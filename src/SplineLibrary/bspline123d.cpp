...
// JSON I/O routines
#ifdef BSIO
BsplineBasis1d::BsplineBasis1d(const json11::Json &json)
{
...
Bspline1d::Bspline1d(const json11::Json &json) : BsplineBasis1d(json)
{
    json11::Json::array data = json["data"].array_items();
...
void Bspline1d::ToJson(json11::Json::object &json)
{
...
// JSON I/O routines
#ifdef BSIO
BsplineBasis2d::BsplineBasis2d(const json11::Json &json)
{
    ...
    xintervals = json["xintervals"].int_value();
    ymin = json["ymin"].number_value();
    ymax = json["ymax"].number_value();
    yintervals = json["yintervals"].int_value();

    Init(xmin, xmax, xintervals, ymin, ymax, yintervals);
}

Bspline2d::Bspline2d(const json11::Json &json) : BsplineBasis2d(json)
{
    json11::Json::array data = json["data"].array_items();
...
void Bspline2d::ToJson(json11::Json::object &json)
{
...
// JSON I/O routines
#ifdef BSIO
BsplineBasis3d::BsplineBasis3d(const json11::Json &json)
{
    double xmin, xmax, ymin, ymax, zmin, zmax;
    int xintervals, yintervals, zintervals;
    ...
    zintervals = json["zintervals"].int_value();

    Init(xmin, xmax, xintervals, ymin, ymax, yintervals, zmin, zmax, zintervals);
}

Bspline3d::Bspline3d(const json11::Json &json) : BsplineBasis3d(json)
{
    json11::Json::array dataz = json["data"].array_items();
    ...
    for (int i=0; i<nbasz; i++) {
        json11::Json::array dataxy = dataz[i].array_items();
...
void Bspline3d::ToJson(json11::Json::object &json)
{
