...
const QString DESCheckUpItem::getToolTip() const
{
    return state == TriStateWarning ? "Other PMs have overriden scalars, but this one does not" : "";
}
